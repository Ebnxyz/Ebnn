...
// You MUST set RESEND_API_KEY in your Vercel project settings.
...
export default async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ message: 'Failed to send messages. Please check server logs.', error: error.message });
    }
};
